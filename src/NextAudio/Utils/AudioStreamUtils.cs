...
public static class AudioStreamUtils
{
    ...
    /// <summary>
    /// Seek the <see cref="AudioStream" /> if the stream doesn't support seek, try forcelly seek.
    /// </summary>
    ...
    /// </exception>
    /// <exception cref="NotSupportedException">Cannot seek the stream even forcelly.</exception>
    ...
    /// <param name="position">The current <paramref name="stream" /> position.</param>
    /// <returns>
    /// A <see cref="ValueTask" /> that represents an that represents an asynchronous operation
